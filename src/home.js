...
const sections = [
    {
        "img": "./images/images-home-page/desert-1.webp", 
        "img-backup": "./images/images-home-page/desert-1.jpg", 
    ...
    {
        "img": "./images/images-home-page/desert-2.webp", 
        "img-backup": "./images/images-home-page/desert-2.jpg", 
    ...
    {
        "img": "./images/images-home-page/desert-3.webp", 
        "img-backup": "./images/images-home-page/desert-3.jpg", 
...
const renderHomePage = () => {
    ...
    sections.forEach((sec, index) => {
        ...
        pimg.setAttribute("onerror", `onerror=null; this.src = ${sec["img-backup"]}`)
